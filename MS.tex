...
% TO DO : maybe explain in one sentence that mixing RGR and AGR is not a heresy here because we are not expecting different pattern with RGR vs AGR except for seedmass in seedling
