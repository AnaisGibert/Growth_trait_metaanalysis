...
\caption{\textbf{Growth (absolute vs relative, and measurement) used by traits and by stage.} Results shown here are from the ``complete'' dataset (recorded under both unstressed and stressed conditions). On the right side of each graph are the Absolute growth rates (AbsGR), on the left side the relative growth rate (RGR).}
\label{fig:figA8}
\end{figure}
