...
May we please raise with you an issue about the literature cited? (It need not affect the review process.) We strongly believe that authors whose data publications enter into meta-analyses deserve to get credit via citation. But because of the restriction on citations in the main text, these citations are in appendices in the current draft, rather than in the main list of Literature Cited. We hope you may have a solution to situations of this kind? We understand some journals now make provision for literature cited in appendices or supp info to be scanned by ISI and other cite-counting agencies? Or perhaps the restrictions on number of papers cited can be relaxed for meta-analyses?
...
\textbf{Keywords (8/10)} asymptotic maximum height, maximum photosynthetic rate, plant ontogenetic stage, plant functional traits, plant growth strategy, seed mass, specific leaf area, wood density

\textbf{Type of article} Letters

\textbf{Number of words in the abstract} 148

\textbf{Number of words in the main text (excluding abstract, acknowledgements, references, table and figure legends)}

\textbf{Number of words in each text box} 0

\textbf{Number of general references}

\textbf{Number of data source references} 108

\textbf{the number of figures} 2

\textbf{the number of tables} 0

\textbf{the number of text boxes} 0

\textbf{the name and complete mailing address (including telephone and fax numbers and e-mail address) of the person to whom correspondence should be sent}




\todo[inline,color=white]{Tentatively for Ecology Letters [length limits: maximum of 5000 words (main text), 2/6 figures, tables or boxes, and 64/50 references.] (4667 word  /5000)}

\todo[inline,color=white]{1. need to delete references 57/50}

\todo[inline,color=white]{2. need to reduce nb words abstract 148/150: DONE}

\todo[inline,color=white]{3. the bibliography style needs to be changed to fit with the new style of Ecology letters: journal abbreviation}

\todo[inline, color=white] {4. to re write Appendix A growth equation : do we keep equation? information about plant size?}

\todo[inline, color=white] {5. to write a "Read.me" file for the dataset/guithub}

\todo[inline, color=white] {6. to add the list of traits/stage categoreis combiation for which we identified a need of more data in the last paragrph of the discussion: DONE}

\todo[inline, color=white] {7. to add subsections in Discussion: DONE}
...
As plants approach maximum height they increasingly divert energy away from growth and into reproduction (see \citealt{Wenk:2014jz, Falster:2011ii,Thomas:1996do}). For seedlings, where all individuals are investing solely in growth, we expect no influence of Hmax on growth. As plants become larger, species with smaller Hmax are expected to be allocating more to reproduction and less to growth, because at any given size they are closer to their Hmax.
...
Each study had to meet some basic criteria to be included in our analysis. We restricted our meta-analysis to documents reporting: i) the relationship between growth and trait as a correlation coefficient, ii) the sample size and the number of species used to perform the correlation, and iii) the size/stage of plants. Where available we also recorded the geographic coordinates, number of sites, experiment type (greenhouse, field experiment, forest, shade-house etc.), growth measure (relative or absolute growth rate measured using plant diameter, height or mass), vegetation type, life form (tree, woody or mixed with herbaceous species etc.), biological scale (interspecific, intraspecific or intragenus), and experimental treatments (e.g.~fertilization, shade, salt stress). Ultimately data was included from 108 different studies \citep{Aiba:1997ho, Aiba:2009ft, Antunez:2001gk, Atkin:1998in, augspurger_light_1984, baltzer_physiological_2007, baraloto_differential_2006, baraloto_seed_2005, Bloor:2003fa, Bohlman:2006eo, Broncano:1998ck, Brown:1996ks, Bruhn:2000jz, Cai:2007ie, CamaraZapata:2003df, CastroDiez:1998gz, CastroDiez:2003jd, Cernusak:2008ds, Chao:2008hg, Chaturvedi:2011jx, Chave:2009iy, Cochard:2007bn, Coley:1983hk, Comas:2002wt, Comas:2004jza, coomes_comparison_1998, coomes_greater_2009, cornelissen_seedling_1996, Cornelissen:1997fd, Cornelissen:1998ta, Dalling:2004gs, DeBell:1994ix, Easdale:2009gv, fan_hydraulic_2012, Fayolle:2012bx, Fujimoto:2006fg, Galmes:2005fa, gleeson_plant_1994, grotkopp_toward_2002, Grubb:1996kr, Herault:2011dd, Huante:1995fd, Huante:1995tl, Huante:1998bk, HUNT:1997ge, Iida:2014ep, Iida:2014hq, king_influence_1994, king_tree_2005, King:2006dg, King:2006he, Kitajima:1994ez, Kohyama:2003dk, Kruger:2006fq, Lamers:2006dl, LopezIglesias:2014dk, Loveys:2002hj, Lusk:1997ga, Lusk:2002fma, Lusk:2013bq, Lusk:2013hz, MartinezVilalta:2010iq, McCormack:2012ch, Moya:2008ep, MullerLandau:2004dc, Nascimento:2005kl, Osone:2008dr, Osunkoya:1994ip, Osunkoya:2010ef, Paz:2005kx, Poorter:1999fp, Poorter:2001fj, Poorter:2006vb, Poorter:2008iu, Poorter:2010co, Popma:1988tv, Prior:2004cv, Read:2011du, Reich:1998ir, Reich:1998ja, Reich:1998vb, Rossatto:2009gq, RuizRobleto:2005hc, Sack:2004hm, saldana-acosta_seedling_2009, SalgadoLuarte:2012ci, Saverimuttu:1996ih, Schulze:2006ww, Shen:2014fw, Shipley:2002fs, Stratton:2001ck, Thomas:1996do, Tjoelker:1999gp, Tobner:2013cv, Tomlinson:2014im, Veneklaas:2002dt, Villagra:2013do, walters_are_1996, Walters:1993eu, Walters:1993hf, Warren:2005bc, Westbrook:2011ja, Wright:1999ds, Wright:2000kw, Wright:2001gb, Wright:2003kb, Wright:2010tp, Zhang:1995bh}.
...
% * <ian.wright@mq.edu.au> 2015-04-29T07:20:39.057Z:
%
% did all these authors really report that GR-SLA relationships diminish in strength with plant size? That is how it reads, but I don't think that's true???
%

%% Anais:
% wright et al 2010 "There is a strong negative relationship between LMA and early seedling growth rates; however, direct limitation of growth rates by large LMA decreases in importance as trees mature and leaf number increases (Lambers and Poorter 1992, Reich et al. 1992, Poorter et al. 2009).

% Poorter et al 2008: "Specific leaf area may be important for the performance of small plants, as leaf removal has a large impact on their survival (e.g., Pearson et al. 2003), but less important for the performance of large trees that have substantial reserves to recuperate from photosynthetic biomass loss (Wu ̈ rth et al. 2005). Similarly, SLA may be more important for light interception of saplings for which it determines to a large extent the total leaf area and leaf area ratio, but less so for large trees, for which leaf area and light interception are largely determined by branching patterns, the number of meristems, and tree architecture (Sterck and Bongers 2001)."

% Reich et al (1992): "Leaf mass per area illustrates two of the reasons that trait–demography relationships might be inherently weak at the sapling stage. The first is ontogenetic. There is a strong negative relationship between LMA and early seedling growth rates; however, direct limitation of growth rates by large LMA decreases in importance as trees mature and leaf number increases (Lambers and Poorter 1992, Reich et al. 1992, Poorter et al. 2009)."
...
\bibliography{references/complete}\label{references}
...
\caption{\textbf{The relationship between growth rates and SLA or seed mass changes with plant stage.} Plots show the effect size (+ 95\%CI) of the correlation between growth rate and five functional traits for plant stage comparisons. \textbf{a)} Specific leaf area (SLA), \textbf{b)} Wood density (WD), \textbf{c)} Asymptotic height (Hmax) \textbf{d)} Seed mass and \textbf{e)} Assimilation rate of CO2 (Aarea). Effect size is a standardized measure of the deviation of the correlation coefficient from zero (Fisher's z-transformed). Effects are significant if confidence intervals (+ 95\%CI) for a given stage do not overlap with zero.  Black symbols for "ideal" data (using only interspecific correlations, growth under control conditions), grey symbols using "complete" data (see Methods for further explanation). 'n' indicates number of correlations contributing to each effect. Likelihood Ratio Tests (LRT, for ideal data only) compared maximum-likelihood fits between a pooled model and one separated by stage. If the LRT returned a significant p-value, the stage model fitted the data better than the null model.
}
\label{Fig2}
...
We adapted growth equations from \cite{Falster:2011ii} and \cite{falster:2013} to generate hypotheses on both absolute and relative growth rates in biomass (b, eqn \ref{eq:eq1}), height (H, eqn \ref{eq:eq2}) and diameter (D, eqn \ref{eq:eq4}). These size dimensions are measured on seedling and adult plants. Here we provide a brief overview of the model; an upcoming publication will elaborate further on the predicted relationships between traits and growth rate.

Let $m_i$ denote the mass, $r_i$ the mass-specific respiration rate, and $k_i$ the turnover rate of different plant tissues, with the subscripts $i=l,s,r,t$ referring to leaves, sapwood and bark, roots, and total plant. Similarly let $a_i$ denote areas, of leaves ($i=l$) and of cross-sections of total stem, sapwood and heartwood ($i= st,ss,sh$) respectively.

The rate at which biomass $b$ of the plant increases is given by
%MW: phrasing changed here and a bit under the equations because I would say that "biomass originating from the plant" should be regarded as including turnover
\begin{equation}\label{eq:eq1}
\underbrace{\frac{db}{dt}}_{\text{biomass increase rate}} = \underbrace{y}_{\text{yield}}  \big(\underbrace{a_{l} A_{\textrm{area}}}_{\text{photosynthesis}} - \underbrace{\sum_{i=l,s,r} m_{i} r_{i}}_{\text{respiration}}\big) - \underbrace{ \sum_{i=l,s,r} m_{i} k_{i}}_{\text{turnover}},
\end{equation}
where $y$ is the fraction of assimilated carbon fixed into biomass,  and  $A_{\textrm{area}}$ is the assimilation rate of CO$_{2}$ per leaf area. Height growth rate can then be expressed as
\begin{equation}\label{eq:eq2}
\underbrace{\frac{dH}{dt}}_{\text{growth rate in height}} = \underbrace{\frac{dH}{da_{l}}}_{\text{architecture layout}} \times \underbrace{\frac{da_{l}}{dm_{t}}}_{\text{leaf deployment per mass}} \times \underbrace{\frac{dm_t}{db}}_{\text{allocation to growth}}  \times \underbrace{\frac{db}{dt}}_{\text{biomass increase rate}}.
\end{equation}

where allocation to growth is the fraction of biomass increase that goes to vegetative growth rather than to seed production. Similarly basal area growth can be expressed as
...
For the case of seedlings, eqn \ref{eq:eq1} can be simplified considerably. Turnover of tissues has not yet begun. It is common also to ignore respiration of non-leaf tissues and to let leaf respiration rate be proportional to leaf area. Biomass growth rate then becomes a linear function of leaf area:
%MW: I wonder whether it might be better to think of this as letting total respiration (including roots) be proportional to leaf area?
\begin{equation}\label{eq:eq1_seedlings}
\frac{db}{dt}  \approx  a_{l} \, y \, (A_{\textrm{area}} - r_{l}).
\end{equation}
A relative growth rate (RGR) in mass can be obtained by dividing both sides of this simplified eq \ref{eq:eq1_seedlings} by the total mass of living tissues $m_{t} = m_{l} + m_{s} + m_{r}$. The outcome is equivalent to the classical partitioning of RGR \citep{Lambers:1992bj, Cornelissen:1998ta}:
\begin{equation}\label{eq:eq1_seedlings_RGR}
\textrm{RGR}  \approx \textrm{NAR} \times  \textrm{SLA} \times  \textrm{LMF},
\end{equation}
 where NAR is net assimilation rate ($y \, (A_{\textrm{area}} - r_{l})$), SLA = $a_{l}/ m_{l}$ and LMF is leaf mass fraction ($m_{l}/ m_{t}$).

The predicted effects of different traits on growth can then be understood by considering the influence of trait variation on elements of equations  \ref{eq:eq1}-\ref{eq:eq4} and how these may interact with plant size.

\begin{table}[ht]
\centering
\caption{\textbf{ Hypothesised effect of traits on components of growth. Arrows indicate the effect an increase in trait value would have on elements of growth (as described  in Eqs. \ref{eq:eq1}-\ref{eq:eq4}) and other aspects of life history.}}
  \begin{tabular}[c]{l|c|cccc|c|c}
  \multicolumn{8}{c}{}\\ \hline
  & \multicolumn{7}{c}{\textbf{Effect of trait on}}\\
  & \textbf{Birth} & \multicolumn{4}{c|}{\textbf{Growth}} & \textbf{Survival} & \textbf{Fecundity} \\
  & \textbf{size}
  & $\frac{\textrm{d}a_\textrm{l}}{\textrm{d}m_\textrm{t}}$
  & $\frac{\textrm{d}m_\textrm{t}}{\textrm{d}b}$
  & $\frac{\textrm{d}b}{\textrm{d}t}$
  & $k_s$ & &  \\\hline
  Seed size & $\uparrow$ & & & & & & $\downarrow$ \\
  Aarea & & & & $\uparrow$& &  \\
Leaf mass per area & & $\downarrow$ & & $\uparrow$ & &  \\
  Wood density& & $\downarrow$ &  & & & $\uparrow$  \\
  Maximum height & & &$\uparrow$ & & & & $\downarrow$  \\
\hline
%MW I'm struggling to understand why db/dt should be one of the terms listed under "growth" -- surely it just is growth, not one of the contributing terms in a growth eqn?
%MW I think this probably should be done in terms of SLA rather than LMA -- that's the way most of the rest of the paper is done from memory, and especially the immediate next para
%MW does SLA not affect leaf turnover rates? (also the text does actually slightly refer to WD affecting sapwood turnover, but this is complicated and I can appreciate it may be better to evade this issue here)
%MW the up-and-down for Aarea seems too complicated (see comment below) -- have replaced with a simple up
%MW I'm inclined to think the columns for birth size, survival and fecundity don't help here -- I understand the logic, but mostly we don't discuss or explain them and so they're distracting
  \end{tabular}
\label{tab:trade-offs}
\end{table}

First, the relationship between SLA and growth rate is predicted to shift from positive for seedlings to non-significant or negative in adult plants, regardless of the growth measurement used.  For seedlings (eq. \ref{eq:eq1_seedlings_RGR}) cheaper leaf construction (high SLA) should translate directly into faster relative growth rate in mass. For larger plants (eq. \ref{eq:eq1}-\ref{eq:eq4}), SLA is expected to affect growth rate positively through more cost-efficient deployment of leaf area (via $da_l/dm_t$); the same effect as in seedlings), but also negatively via increased leaf turnover (eqn 1; Table \ref{tab:trade-offs}). The effect of SLA on $da_l/dm_t$ decreases as plant size increases and increasing amounts of the plant are wood. Consequently the effect of turnover costs in slowing growth comes to dominate at larger sizes.
%MW: I suggest we should not use phrases like "regardless of the growth measurement used" except in cases where we're actually going to explain properly. Currently eqns 1-5 are expressed as absolute growth rate and eqn 6 as RGR. But nowhere do we make explicit comparisons of an absolute growth eqn with a relative growth eqn
Second, the relationship between WD and growth rate is predicted to be negative across all plant sizes. Cheaper stem construction (low WD or stem density) also increases the marginal rate of leaf deployment per total mass increment (via $da_l/dm_t$), and consequently increases growth rate in leaf area, height and diameter (eqs. \ref{eq:eq2}-\ref{eq:eq4}). Disadvantages associated with cheap stem construction take the form of higher mortality and so are not reflected in growth equations (Table \ref{tab:trade-offs}). Under this scenario, wood density is negatively correlated to growth rate across all plant stages. Because the relative expenditure on stem compared to leaf is expected to increase as plants grow larger, the relationship between WD and growth may also strengthen in larger plants.

Third, the relationship between height at maturation (Hmax) and growth rate is predicted to be positive in adults, whereas no correlation is expected for seedlings and juveniles. Hmax affects growth via the fraction of energy allocated to vegetative growth versus to seed production  (dmt/db in eqn 2; Table \ref{tab:trade-offs}). For juveniles and seedlings this fraction is 1 for all species and so no effect is expected. But once some species begin to produce seed, then species closer to their Hmax value are expected to be allocating more to seed production and less to vegetative growth. Hence when comparing across plants at a given size, species with smaller Hmax are expected to show slower vegetative growth rates.

Fourth, the relationship between seed mass and relative growth rate is predicted to be negative in seedlings. This is because the relative growth rate slows as plants grow larger, and large-seeded species begin larger as seedlings. For larger plants, seed mass is not expected to have any distinct influence on growth rates  (Table \ref{tab:trade-offs}).
%MW: in my opinion the -ve correlation expectation applies only to RGR not to absolute growth rate
Finally, the relationship between Aarea and growth should be positive across all plant sizes (eqn 1). The effects of benefits (higher assimilation) and costs (higher respiration) of increased Area occur within the same element of equations 1 and 5, and assimilation must outweigh respiration for there to be growth, so the net effect will be positive (Table \ref{tab:trade-offs}).
%MW is that what the up-and-down arrows in the table are meant to convey? Too complicated I suggest -- and also it doesn't actually explain why r'ship is positive, though it does explain why it's consistent across sizes. Have suggested a rewrite.
...
rate and traits, established from 107 published articles.} The mean
...
\caption{\textbf{Effects size on the correlation between growth and
traits of plant stage (mod1, as recorded by the authors), vegetation type
(mod2), growth measurement (mod3) and experiment type (mod4).} The effect size
(z) is reported for each class, with its 95\%CI and models are fitted by
restricted max likelihood (REML). n= number of correlation r reported.
(Abbreviation: boreal\&temp = mix boreal and temperate deciduous forest,
med= Mediterranean, across veg = correlation performed on species from
more than 2 vegetation types, temp\&med = mix between temperate
deciduous and Mediterranean forest, temp= temperate deciduous forest,
temp rain= temperate rain forest, trop rain= tropical rain forest, trop
seas = tropical seasonal forest, GR(D)= growth rate measure in diameter,
GR(H) = growth rate in height, GR(M)= growth rate in Mass, RGR(CSA)=
relative growth rate in cross section area, etc). AIC: Akaike
information criterion corresponds to the quality of each model, and
allow a comparison between model. Smallest is the AIC better is the
model. Shown here are complete dataset (recorded at both interspecific and intraspecific level and under unstressed and stressed conditions).}
\label{FigA7}
\end{figure}
...
\caption{\textbf{Funnel plots showing transformed correlation coefficient z between growth and the traits a) Specific leaf area
(SLA), b) Wood density (WD), c) Asymptotic height (Hmax), d) Seed mass and e) Assimilation rate of CO2 (Aarea)}. Shown here are complete dataset (recorded at both interspecific and intraspecific level and under unstressed and stressed conditions). The color of the points corresponds to the stage for which the correlation was measured (Red points : adult, orange point : sapling, grey: juvenile). Note that in these plots the x axis is the number of species included in the correlation, not the replication for the correlation. The number of species is sometimes as low as 1, and these are within-species correlations. The number of replicates used for the correlation coefficient was often much greater than the number of species, especially for studies involving 5 or less species. Nevertheless  the characteristic shape of funnel plots is observed, with correlations involving few species showing much wider variation even though within-species replication was sometimes high.}
