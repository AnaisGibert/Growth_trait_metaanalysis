...
\item Despite a sizeable literature on traits and growth, major knowledge gaps across size-classes still exist; for one-third of traits the majority of correlations with growth ($>$ 75\%) come from a single and unique size-classe. Clearly, there is scope for strengthening our understanding on the link between traits and growth through adding further empirical studies for traits and size-classes underrepresented in the literature.
...
\subsection*{Size-classes representativity among 19 traits recorded}
In total, correlations had been reported for at least two different stages across 18 traits out of the 19 targeted (Fig. \ref{fig:fig1}). We had thought it likely that for some traits correlations would be reported only for one size class. But this limitation applied only for LAR and NARmass, where studies appeared confined to seedling stages. However, for a majority of traits the number of observations across stage was higthly unbalanced; for one-third of the 19 traits $>$ 75\% of correlations with growth reported come from a single and unique plant stage (Fig. \ref{fig:fig1}).
