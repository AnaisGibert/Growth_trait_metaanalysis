...
\keywords{absolute growth rate, maximum height, photosynthetic rate, ontogenetic stage, functional trait, growth strategy, relative growth rate, seed mass, specific leaf area, wood density}
...
\begin{table}[h!]
\centering
\caption{Hypothesised effects of traits on key elements of plant function determining growth rate. Arrows indicate the effect an increase in trait value would have on the main elements of growth eqs. \ref{eq:eq0}-\ref{eq:eq4} in Appendix \ref{sec:growth}, dashes indicate no significant effect. Traits names as in Figure 1. For further details, see Appendix \ref{sec:growth}.}
{\footnotesize
\vspace{1cm}
