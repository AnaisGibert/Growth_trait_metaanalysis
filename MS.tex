...
\todo[inline,color=white]{1. need to delete references 50/50: DONE}

\todo[inline,color=white]{2. need to reduce nb words abstract 148/150: DONE}

\todo[inline,color=white]{3. the bibliography style needs to be changed to fit with the new style of Ecology letters: journal abbreviation: DONE}

\todo[inline, color=white] {4.  re write Appendix A growth equation : DONE}

\todo[inline, color=white] {5. to write a "Read.me" file for the dataset/guithub: DONE}

\todo[inline, color=white] {6. to add the list of traits/stage categories combination for which we identified a need of more data in the last paragraph of the discussion: DONE}

\todo[inline, color=white] {7. to add subsections in Discussion: DONE}

\todo[inline, color=white] {8. list of preferred and non preferred reviewers, to list any editorial board members with whom one of the authors is in conflict: see the list \href{here}{http://onlinelibrary.wiley.com/journal/10.1111/(ISSN)1461-0248/homepage/EditorialBoard.html}}

\todo[inline, color=white] {9. To add asterisk in front of the data-source references and cites them in the text}

\todo[inline, color=white] {10. To delete discussion about references in coverletter: DONE}

\todo[inline, color=white] {11. To add a clear statment in cover letter of how exactely the enclosed work is outstandingly novel relative to recent work by the author and co authors cited in the present submission}

\todo[inline, color=white] {12. to check the number of word in figures legends (less than 150): DONE}
...
For the case of seedlings, eqs. \ref{eq:eq0}-\ref{eq:eq1} can be simplified considerably. Turnover of tissues and allocation to reproduction have not yet begun. It is also common also to assume all respiration rates are proportional to leaf area. Biomass growth rate then becomes a linear function of leaf area:
...
\begin{table}[ht]
\centering
\caption{\linespread{2}\textbf{List of the twenty traits targeted}. Abbreviation,
